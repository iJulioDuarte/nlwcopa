...
import phonesHomeImage from "./../assets/phonesHomeImage.png";
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28">
      <main>
        ...
        <div className="mt-10 flex items-center gap-2 ">
          ...
          <strong className="text-gray-100">
            <span className="text-ignite-500 text-xl">+{props.userCount}</span> pessoas já estão usando.
          </strong>
        </div>
      ...
      <Image
        quality={100}
        src={phonesHomeImage}
        alt="Dois celulares exibindo um exemplo"
      />
    </div>
  );
};
